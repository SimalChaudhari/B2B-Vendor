      ...
      <Main layoutQuery={layoutQuery}>
        <Section
          ...
          methods={[
            {
              label: 'Jwt',
              path: paths.auth?.jwt?.signIn || '/default-signin',
              icon: `${CONFIG.site.basePath}/assets/icons/platforms/ic-jwt.svg`,
            },
            {
              label: 'Firebase',
              path: paths.auth?.firebase?.signIn || '/default-firebase-signin',
              icon: `${CONFIG.site.basePath}/assets/icons/platforms/ic-firebase.svg`,
            },
            {
              label: 'Amplify',
              path: paths.auth?.amplify?.signIn || '/default-amplify-signin',
              icon: `${CONFIG.site.basePath}/assets/icons/platforms/ic-amplify.svg`,
            },
            {
              label: 'Auth0',
              path: paths.auth?.auth0?.signIn || '/default-auth0-signin',
              icon: `${CONFIG.site.basePath}/assets/icons/platforms/ic-auth0.svg`,
            },
            {
              label: 'Supabase',
              path: paths.auth?.supabase?.signIn || '/default-supabase-signin',
              icon: `${CONFIG.site.basePath}/assets/icons/platforms/ic-supabase.svg`,
            },
          ]}
